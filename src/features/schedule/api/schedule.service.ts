...
export const scheduleService = {
  ...
  async getScheduleById(
    id: string
  ): Promise<ApiAttendanceScheduleResponse | null> {
    try {
      const response = await axiosInstance.get(
        `${baseUrl}/attendance-schedules/${id}`
      );
      if (response.status >= 400) {
  ...
  async createSchedule(
    data: CreateAttendanceScheduleRequest
  ): Promise<AttendanceScheduleDetailResponse | null> {
    try {
  ...
  async updateSchedule(
    id: string,
    data: UpdateAttendanceScheduleRequest
  ): Promise<AttendanceScheduleDetailResponse | null> {
    try {
  ...
  async getMySchedules(
    ...
    try {
      const response = await axiosInstance.get(
        `${baseUrl}/attendance-schedules/my-schedules`,
        { params: query }
      );
      if (response.status >= 400) {
  ...
  async updateScheduleDays(
    data: UpdateScheduleDaysRequest
  ): Promise<{ success: boolean; message: string } | null> {
    try {
      const response = await axiosInstance.put(
        `${baseUrl}/attendance-schedules/${data.attendanceScheduleId}/schedule-days`,
        data
      );
      if (response.status >= 400) {
  ...
  async updateScheduleDaysClient(
    data: UpdateScheduleDaysRequest
  ): Promise<{ success: boolean; message: string } | null> {
    try {
      const response = await axiosClient.put(
