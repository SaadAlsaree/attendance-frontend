...
export const organizationalService = {
    ...
    async getOrganizationalUnits(filters?: IOrganizationalUnitQuery) {
        try {
            const response = await axiosInstance.get(`${baseUrl}/organizational-units`, { params: filters });
    ...
    async getOrganizationalUnitsClient(filters?: IOrganizationalUnitQuery) {
        try {
            const response = await axiosClient.get(`${baseUrl}/organizational-units`, { params: filters });
    ...
    async getOrganizationalUnitById(id: string) {
        try {
            ...
            const response = await axiosInstance.get(`${baseUrl}/organizational-units/${id}`);
    ...
    async createOrganizationalUnit(unit: CreateOrganizationalUnitPayload) {
        try {
            const response = await axiosClient.post(`${baseUrl}/organizational-units`, unit);
    ...
    async updateOrganizationalUnit(id: string, unit: CreateOrganizationalUnitPayload) {
        try {
            if (!id) {
                return null;
            }

            const response = await axiosClient.put(`${baseUrl}/organizational-units/${id}`, unit);
    ...
    async deleteOrganizationalUnit(id: string) {
        try {
            ...
            const response = await axiosClient.delete(`${baseUrl}/organizational-units/${id}`);
    ...
    async getOrganizationalUnitTree() {
        try {
            const response = await axiosInstance.get(`${baseUrl}/organizational-units/tree`);
    ...
    async getOrganizationalUnitListById(includeInactive: boolean) {
        try {
            const response = await axiosInstance.get(`${baseUrl}/OrganizationalUnit/GetOrganizationalUnitListById`, {
            ...
            return response.data as IResponseList<IOrganizationalUnitResponse> || null;
        } catch (error) {
            return null;
        }
    },
    ...
    async getOrganizationalUnitListByIdClient(includeInactive: boolean) {
        try {
            const response = await axiosClient.get(`${baseUrl}/OrganizationalUnit/GetOrganizationalUnitList`, {
                params: { includeInactive }
            });
