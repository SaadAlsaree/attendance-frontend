...
import { DashboardStatsData, DashboardStatsRequest } from '../types/dashboard-stats';
...
export const dashboardService = {
    ...
    async getQuickStats(request: QuickStatsRequest): Promise<ApiResponse | null> {
        try {
            const response = await axiosInstance.get(`${baseUrl}/dashboard/quick-stats`, {
                params: request
            });
    ...
    async getDashboardStats(request: DashboardStatsRequest): Promise<DashboardStatsData | null> {
        try {
    ...
    async getDashboardClient(request: DashboardRequest): Promise<DashboardData | null> {
        try {
    ...
    async getQuickStatsClient(request: QuickStatsRequest): Promise<ApiResponse | null> {
        try {
            const response = await axiosClient.get(`${baseUrl}/dashboard/quick-stats`, {
                params: request
            });
    ...
    async getDashboardStatsClient(request: DashboardStatsRequest): Promise<DashboardStatsData | null> {
        try {
