...
export const usersPermissionsService = {
    ...
    async getUsersPermissionsList(query?: {
        ...
        try {
            const response = await axiosInstance.get(`${baseUrl}/users`, { params: query });
            if (response.status >= 400) {
                console.error('Error fetching users permissions list:', response.statusText);
                return null;
            }
    ...
    async createUser(data: CreateUserRequest): Promise<UserPermission | null> {
        try {
            const response = await axiosInstance.post(`${baseUrl}/users-permissions`, data);
            if (response.status >= 400) {
    ...
    // Update user role
    async updateUserRole(id: string, data: UpdateUserRoleRequest): Promise<UserPermission | null> {
        try {
            const response = await axiosInstance.put(`${baseUrl}/users-permissions/${id}/role`, data);
            if (response.status >= 400) {
    ...
    async deleteUser(id: string): Promise<boolean> {
        try {
            const response = await axiosInstance.delete(`${baseUrl}/users-permissions/${id}`);
            if (response.status >= 400) {
    ...
    async changePassword(data: ChangePasswordRequest): Promise<{ success: boolean; message: string } | null> {
        try {
            const response = await axiosInstance.put(`${baseUrl}/users-permissions/change-password`, data);
            if (response.status >= 400) {
    ...
    // Reset password
    async resetPassword(data: ResetPasswordRequest): Promise<{ success: boolean; message: string } | null> {
        try {
            const response = await axiosInstance.put(`${baseUrl}/users/reset-password`, data);
            if (response.status >= 400) {
    ...
    async toggleUserStatus(id: string): Promise<UserPermission | null> {
        try {
            const response = await axiosInstance.put(`${baseUrl}/users-permissions/${id}/toggle-status`);
            if (response.status >= 400) {
    ...
    async getUsersPermissionsListClient(query?: {
        ...
        try {
            const response = await axiosClient.get(`${baseUrl}/users-permissions`, { params: query });
            if (response.status >= 400) {
                console.error('Error fetching users permissions list:', response.statusText);
                return null;
            }
    ...
    async getUserPermissionByIdClient(id: string): Promise<UserPermission | null> {
        try {
            const response = await axiosClient.get(`${baseUrl}/users-permissions/${id}`);
            if (response.status >= 400) {
                console.error('Error fetching user permission:', response.statusText);
                return null;
            }
    ...
    async updateUserRoleClient(id: string, data: UpdateUserRoleRequest): Promise<UserPermission | null> {
        try {
            const response = await axiosClient.put(`${baseUrl}/users-permissions/${id}/role`, data);
            if (response.status >= 400) {
                console.error('Error updating user role:', response.statusText);
                return null;
            }
    ...
    async deleteUserClient(id: string): Promise<boolean> {
        try {
            const response = await axiosClient.delete(`${baseUrl}/users-permissions/${id}`);
            if (response.status >= 400) {
                console.error('Error deleting user:', response.statusText);
                return false;
            }
    ...
    async changePasswordClient(data: ChangePasswordRequest): Promise<boolean> {
        try {
            const response = await axiosClient.put(`${baseUrl}/users-permissions/change-password`, data);
            if (response.status >= 400) {
                console.error('Error changing password:', response.statusText);
                return false;
            }
    ...
    async resetPasswordClient(data: ResetPasswordRequest): Promise<boolean> {
        try {
            const response = await axiosClient.put(`${baseUrl}/users-permissions/reset-password`, data);
            if (response.status >= 400) {
                console.error('Error resetting password:', response.statusText);
                return false;
            }
    ...
    async toggleUserStatusClient(id: string): Promise<UserPermission | null> {
        try {
            const response = await axiosClient.put(`${baseUrl}/users-permissions/${id}/toggle-status`);
            if (response.status >= 400) {
                console.error('Error toggling user status:', response.statusText);
                return null;
            }
